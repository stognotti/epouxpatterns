...
var DataTableResponsiveDemo = (function () {
    ...
    DataTableResponsiveDemo = __decorate([
        core_1.Component({
            ...
            directives: [datatable_1.DataTable, column_1.Column, header_1.Header, button_1.Button, datatablesubmenu_component_1.DataTableSubmenu, tabpanel_1.TabPanel, tabview_1.TabView, codehighlighter_1.CodeHighlighter, router_1.ROUTER_DIRECTIVES],
